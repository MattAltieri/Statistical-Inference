...
$$
    ...
    - Let's flip a coin $n$ times, take the sample proportion of heads, subtract off 0.5 and multiply the result by $2 \sqrt n$ (divide by $1 / (2 \sqrt n)$)
    
## Simulation results

<img src="Asymptotics_files/figure-html/unnamed-chunk-4-1.png" title="" alt="" style="display: block; margin: auto;" />

## Simulation results, $p = 0.9$

<img src="Asymptotics_files/figure-html/unnamed-chunk-5-1.png" title="" alt="" style="display: block; margin: auto;" />
...
- Similarly, $\mu - 2 \sigma / \sqrt n$ is pretty far into the left tail (only 2.5% chance of a normal being smaller than 2 sds in the tail)
- So the probability $\bar X$ is bigger than $\mu + 2 \sigma / \sqrt n$ or smaller than $\mu - 2 \sigma / \sqrt n$ is 5%
    - Or equivalently, the probability of being within these limits is 95%
...
- 90% interval you want (100 - 92) / 2 = 5% in each tail
    - So you want the 05th percentile (1.645)
    
## Given a confidence interval for the average height of sons
...
- In the event that each $X_i$ is 0 or 1 with common success probability $p$ the $\sigma^2 = p(1 - p)$
...
- Rough guidlines, 100 for 1 decimal place, 10,000 for 2, 1,000,000 for 3
...
<img src="Asymptotics_files/figure-html/unnamed-chunk-10-1.png" title="" alt="" style="display: block; margin: auto;" />

## What's happening?
- $n$ isn't large enough for the CLT to be applicable for many of the values $p$
...
- (Add two successess and failures, Agresti/Coull interval)
...
<img src="Asymptotics_files/figure-html/unnamed-chunk-12-1.png" title="" alt="" style="display: block; margin: auto;" />
...
<img src="Asymptotics_files/figure-html/unnamed-chunk-14-1.png" title="" alt="" style="display: block; margin: auto;" />
...
<img src="Asymptotics_files/figure-html/unnamed-chunk-17-1.png" title="" alt="" style="display: block; margin: auto;" />

## What if we increase t to 1000?

<img src="Asymptotics_files/figure-html/unnamed-chunk-18-1.png" title="" alt="" style="display: block; margin: auto;" />
...
- Taking the mean and adding and subtracting the relevant normal quantile times the SE yields a coinfidence interval for the mean
